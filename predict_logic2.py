...
train_df.to_csv("data/pre_processing/processed_train4.csv", index=False)
...
tmp_df = test_data[['Age','Fare', 'Parch', 'SibSp', 'Pclass', 'Title']]
...
test.to_csv("data/pre_processing/processed_test4.csv", index=False)
...
result.to_csv("data/predictions/logistic_regression_predictions2.csv", index=False)
