...
model = keras.models.load_model('model/tf_model2.h5')

test_data = pd.read_csv('data/pre_processing/processed_test5.csv')
test_df = test_data.drop(columns=["PassengerId"])
...
result.to_csv("data/predictions/tf_predictions_model2.csv", index=False)
