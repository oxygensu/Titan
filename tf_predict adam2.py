...
model = keras.models.load_model('model/tf_adam3.h5')

test_data = pd.read_csv('data/processed_test2.csv')
test_df = test_data.filter(regex='Survived|Pclass|Sex|Age|SibSp|Parch|Fare|Embarked')
...
result.to_csv("data/tf_predictions_adam3.csv", index=False)